...
const HereMap = ({ LAT, LONG, markers = [], accuracy }) => {
  ...
  useEffect(() => {
    ...
    const fetchIncidents = async () => {
      const bbox = `${LAT - 0.05},${LONG - 0.05},${LAT + 0.05},${LONG + 0.05}`;
        ...
        const res = await axios.get(
          "https://data.traffic.hereapi.com/v7/incidents",
          {
            params: {
              ...
              // in: "bbox:12.848786114443566,77.5224511321034,12.948786114443568,77.6224511321034",
               in: "circle:12.9716,77.5946;r=20000",
